...
const Navbar = () => {
    ...
    return (
      <nav className='w-full h-24 flex flex-col justify-center bg-white fixed z-20'>
        <div className='container mx-auto lg:px-6'>
          <div className='lg:w-full w-11/12 mx-auto h-full flex justify-between items-center'>
            <div className='flex flex-col gap-y-4'>
              <div className='flex items-center gap-x-2'>
                <span className='flex items-center lg:text-5xl text-3xl'>
                  <p className='font-bold leading-light text-primary'>Job</p>
                  <p className='font-semibold leading-light'>Journey</p>
                </span>
              </div>
            </div>
          ...
          {dropdown ? (
            <div onClick={showDropdown} className='lg:hidden w-full h-[100vh] fixed top-24 bg-gray-400 ease-in-out duration-100'>
              <div className='w-full h-[320px] flex flex-col items-baseline pt-8 gap-4'>
                <ul className='text-center p-0 flex flex-col justify-center w-full gap-y-8'>
                  <a href="#" className='leading-normal no-underline text-white font-bold text-lg hover:text-primary'>
                    Find Job
                  </a>
